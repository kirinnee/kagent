...
import type {
  ...
  IFileSystemAdapter,
  IProcessAdapter,
} from '../../src/lib/interfaces.ts';

// ===== Test Doubles (inlined to avoid coverage contamination) =====

/**
 * Silent console - captures output without printing
 */
class SilentConsole implements IConsoleAdapter {
 ...
 */
class MemoryEnvironment implements IEnvironmentAdapter {
 ...
 */
class MockProcess implements IProcessAdapter {
  public exitCode = 0;
